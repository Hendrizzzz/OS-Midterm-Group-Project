...
echo "1. All time rebounds leaders"
echo "2. Rebounds leaders (for specific season)"
echo "3. All time RPG leaders"
echo "4. RPG leaders (for specific season)"
...
case $choice in
    1) rebounds_leaders_all_time ;;
    2) rebounds_leaders_per_season ;;
    3) rpg_leaders_all_time ;; 
    4) rpg_leaders_per_season ;;
    *) echo "Invalid choice." ;;
esac
