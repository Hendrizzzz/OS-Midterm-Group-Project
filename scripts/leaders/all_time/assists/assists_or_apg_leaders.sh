...
echo "1. All time assists leaders"
echo "2. Assists leaders (for specific season)"
echo "3. All time APG leaders"
echo "4. APG leaders (for specific season)"
...
case $choice in
    1) assists_leaders_all_time ;;
    2) assists_leaders_per_season ;;
    3) apg_leaders_all_time ;; 
    4) apg_leaders_per_season ;;
    *) echo "Invalid choice." ;;
esac
